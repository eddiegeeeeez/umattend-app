 ...
 * This script starts both the frontend (Next.js) and backend (Express) servers in production mode
 */
...
╔═══════════════════════════════════════════════╗
║     UMAttend Production Server Starter        ║
╚═══════════════════════════════════════════════╝
${colors.reset}`);
...
s
console.log(`${prefix.main} ${colors.yellow}Launching production servers...${colors.reset}\n`);

const serverProcess = startProcess('server', 'prod', 'server', colors.magenta);
const clientProcess = startProcess('client', 'start', 'client', colors.cyan);
...
console.log(`\n${prefix.main} ${colors.green}Both servers are running in production mode...${colors.reset}`);
