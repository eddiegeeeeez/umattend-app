            ...
            <div className="flex flex-col items-start gap-10 lg:flex-row">
              ...
              <div className="flex flex-col items-center gap-8 w-full lg:w-80 lg:items-start">
                ...
                <div className="w-full text-center lg:text-left">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="border-border bg-background/90 rounded-xl border p-4 text-center shadow-sm transition-shadow hover:shadow-md min-w-0">
              ...
              <div className="flex w-full flex-1 flex-col gap-8">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="border-border bg-background/90 hover:border-primary/50 rounded-xl border p-4 shadow-sm transition-all hover:shadow-md flex items-center gap-3 min-w-0">
                    <div className="bg-primary/10 flex h-10 w-10 items-center justify-center rounded-lg flex-shrink-0">
        ...
        <div className="mt-14">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {pastEvents.map((event) => (
              <div
                key={event.id}
                className="group border-border bg-card hover:border-primary/50 rounded-xl border shadow-md transition-all duration-300 hover:shadow-xl flex flex-col justify-center px-6 py-5"
              >
                <div className="flex flex-col gap-2">
                  <h3 className="text-foreground group-hover:text-primary mb-1 truncate text-lg font-bold transition-colors flex items-center gap-2">
                    {event.title}
                  </h3>
