                ...
                properties: {
                  ...
                  data: {
                    ...
                    properties: {
                      ...
                      start_time: { type: 'string', format: 'date-time', example: '2025-10-15T09:00:00.000Z' },
                      end_time: { type: 'string', format: 'date-time', example: '2025-10-15T17:00:00.000Z' },
                ...
                properties: {
                  ...
                  data: {
                    ...
                    properties: {
                      ...
                      checked_in_at: { type: 'string', format: 'date-time', example: '2025-10-15T09:30:00.000Z' },
                ...
                properties: {
                  ...
                  data: {
                    ...
                    properties: {
                      event_id: { type: 'string' },
                      event_name: { type: 'string' },
                      checked_out_at: { type: 'string', format: 'date-time', example: '2025-10-15T17:30:00.000Z' },
                ...
                properties: {
                  ...
                  data: {
                    ...
                    properties: {
                      ...
                      user_id: { type: 'string' },
                      event_id: { type: 'string' },
                      created_at: { type: 'string', format: 'date-time', example: '2025-10-15T08:00:00.000Z' },
                    },
                  },
                },
              },
